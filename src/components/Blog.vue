...
<template>
  <div id="content" class="container">
    ...
    <Block title="HKUST Examination management system" color="orange">
      ...
      <img alt="snapshot" src="../assets/comp3111.png" width="100%"/>
    </Block>
    <Block title="Forest Hunter" date="2024-9-11"  color="red">
      ...
      <img alt="snapshot" src="../assets/foresthunter.png" width="100%"/>
    </Block>
    ...
    <Block title="Raytracer" color="blue">
      ...
      <img alt="snapshot" src="../assets/raytracer.png" width="100%"/>
    </Block>
  </div>
</template>
